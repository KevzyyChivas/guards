...
RoleGuard.login(process.env.roleguard);
...
ChannelGuard.login(process.env.channelguard);
...
OtherGuard.login(process.env.otherguard);
//#endregion

//#region Yan Korumalar

process.env.guard.forEach(async guard => {
